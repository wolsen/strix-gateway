...
"""Entry point for the apollo-svc-shell ForceCommand.
...
from apollo_gateway.personalities.svc.audit import parse_ssh_connection

logger = logging.getLogger("apollo_gateway.personalities.svc.shell")
