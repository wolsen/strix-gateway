...
from apollo_gateway.core.db import Array, Mapping, Pool, Volume
...
logger = logging.getLogger("apollo_gateway.core.volumes")
...
async def create_volume(
    ...
    *,
    ...
    """
    from apollo_gateway.spdk.ensure import ensure_lvol
...
async def delete_volume(
    ...
    :class:`BackendError` on SPDK failure.
    """
    from apollo_gateway.spdk.ensure import delete_lvol
...
async def extend_volume(
    ...
    """
    from apollo_gateway.spdk.ensure import resize_lvol
