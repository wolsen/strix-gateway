...
_diag = logging.getLogger("strix_gateway.personalities.svc")
...
async def audited_dispatch(
    ...
    *,
    ...
    """Wrap :func:`~strix_gateway.personalities.svc.handlers.dispatch` with
    ...
    ctx:
        Initialised :class:`~strix_gateway.personalities.svc.handlers.SvcContext`.
    audit:
