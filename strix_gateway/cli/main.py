...
def array_set_capabilities(
    ...
    from strix_gateway.cli.topo.load import load_capability_file
...
def apply_cmd(
    ...
    from strix_gateway.cli.topo.apply import apply_topology
    from strix_gateway.cli.topo.load import load_topology
    from strix_gateway.cli.topo.validate import validate_topology
...
def smoke_cmd(
    ...
    from strix_gateway.cli.topo.apply import smoke_test
    from strix_gateway.cli.topo.load import load_topology
    from strix_gateway.cli.topo.validate import validate_topology
