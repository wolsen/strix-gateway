...
from strix_gateway.core.db import get_session_factory

logger = logging.getLogger("strix_gateway.api.vhost")
...
async def sync_tls(request: Request):
    ...
    from strix_gateway.api.arrays import _refresh_vhost_state
